  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-4 gap-6 p-4">
        {/* Product Card */}
        <Link to={"/detail-sleeps"}>
          <div className="bg-white shadow-lg rounded-lg p-4 hover:shadow-[#019B7E] transition-shadow duration-300">
            <img
              src="src/assets/sleep/sleep1_iteam/sleep_item1.webp"
              alt="Easy Camp Spirit"
              className="mb-4 w-full h-[170px]"
            />
            <h3 className="text-[#019B7E] text-[11px] mb-2">
              Outwell Camper Lux Sleeping Bag Single – Left Hand Zip
            </h3>
        ...
        <a href="#">
          <div className="bg-white shadow-lg rounded-lg p-4 hover:shadow-[#019B7E] transition-shadow duration-300">
            <img
              src="src/assets/sleep/sleep1_iteam/sleep_item2.webp"
              alt="Easy Camp Quasar"
              className="mb-4 w-full h-[170px]"
            />
            <h3 className="text-[#019B7E] text-[11px] mb-2">
              Outwell Freeway Single Sleeping Bag 2024
            </h3>
            <p className="text-black text-sm font-bold">$29.95</p>
            <button className="mt-2 bg-[#019B7E] text-white text-[11px] px-4 py-2 rounded hover:bg-[#017a63] transition-colors duration-300">
              ADD TO BASKET
            </button>
          </div>
        ...
        <a href="#">
          <div className="bg-white shadow-lg rounded-lg p-4 hover:shadow-[#019B7E] transition-shadow duration-300">
            <img
              src="src/assets/sleep/sleep1_iteam/sleep_item3.webp"
              alt="Coleman Darwin"
              className="mb-4 w-full h-[175px]"
            />
            <h3 className="text-[#019B7E] text-[11px] mb-2">
              Robens Gully 900 -10°C Sleeping Bag LH Zip
            </h3>
            <p className="text-black text-sm font-bold">$109.50</p>
            <button className="mt-2 bg-[#019B7E] text-white text-[11px] px-4 py-2 rounded hover:bg-[#017a63] transition-colors duration-300">
              ADD TO BASKET
            </button>
          </div>
        ...
        <a href="#">
          <div className="bg-white shadow-lg rounded-lg p-4 hover:shadow-[#019B7E] transition-shadow duration-300">
            <img
              src="src/assets/sleep/sleep1_iteam/sleep_item4.webp"
              alt="Robens Arch"
              className="mb-4 w-full h-[175px]"
            />
            <h3 className="text-[#019B7E] text-[11px] mb-2">
              Outwell Canella Sleeping Bag Single
            </h3>
            <p className="text-black text-sm font-bold">$39.99</p>
            <button className="mt-2 bg-[#019B7E] text-white text-[11px] px-4 py-2 rounded hover:bg-[#017a63] transition-colors duration-300">
              ADD TO BASKET
            </button>
          </div>
        ...
        <a href="#">
          <div className="bg-white shadow-lg rounded-lg p-4 hover:shadow-[#019B7E] transition-shadow duration-300 mt-5">
            <img
              src="src/assets/sleep/sleep1_iteam/sleep_item5.webp"
              alt="Outwell Free Standing Inner"
              className="mb-4 w-full h-[175px]"
            />
            <h3 className="text-[#019B7E] text-[11px] mb-2">
              Easy Camp Orbit 300 Sleeping Bag
            </h3>
            <p className="text-black text-sm font-bold">$37.95</p>
            <button className="mt-2 bg-[#019B7E] text-white text-[11px] px-4 py-2 rounded hover:bg-[#017a63] transition-colors duration-300">
              ADD TO BASKET
            </button>
          </div>
